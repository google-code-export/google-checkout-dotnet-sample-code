...
namespace GCheckout.OrderProcessing {
  ...
  /// TODO
  /// </summary>
  public class NotificationDataTokenResponse : GCheckoutResponse {
    
    private AutoGen.NotificationDataTokenResponse _response;

    /// <summary>
    /// Create a new Instance of the Data Token Response
    /// </summary>
    /// <param name="responseXml"></param>
    public NotificationDataTokenResponse(string responseXml)
      : base(responseXml) {
    ...
    protected override bool ParseMessage() {
      try {
        if (ResponseXml.IndexOf("<notification-data-token-response") > -1) {
