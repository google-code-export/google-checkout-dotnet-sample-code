...
order management system. There are two advantages to this approach:

1. Increased scalability. Because the notification listener is fast, it can receive heavy notification volume without failing. The the heavier notification processer can catch up on the stored notifications at leisure.
